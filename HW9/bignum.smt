...
; /comp/105/build-prove-compare/examples/usmalltalk/predefined.smt
...
(class Block
    ...
    (method value:value:value:       (a1 a2 a3)
                                                (primitive value self a1 a2 a3))
...
(class Natural
   [subclass-of Magnitude]
    ...
    (class-method first:rest: (anInt aNatural) ( ;returns natural
        ((anInt = 0) & (aNatural isZero)) ifTrue:ifFalse:
            [block () (NatZero new)]
            [block () (NatNonZero new:: aNatural anInt)]
    )) ; private

   (class-method fromSmall: (anInteger) ( ;returns natural
        (anInteger = 0) ifTrue:ifFalse:
          [block () (NatZero new)]
          [block () (Natural first:rest: (anInteger mod: (Natural base))
                          (Natural fromSmall: (anInteger div: (Natural base))))]
   ))
   (class-method base () 64) ; private

   (method modBase () (self subclassResponsibility)) ; private returns natural
   (method divBase () (self subclassResponsibility)) ; private returns int
   (method timesBase () (self subclassResponsibility)) ; private returns natural
   (method compare:withLt:withEq:withGt: (aNatural ltBlock eqBlock gtBlock)
           (self subclassResponsibility))
   (method plus:carry: (aNatural c) (self subclassResponsibility)) ; private
   (method minus:borrow: (aNatural c) (self subclassResponsibility)) ; private
   ...
   (method + (aNatural) (self subclassResponsibility)) ;returns natural
   (method * (aNatural) (self subclassResponsibility)) ;returns natural
   (method - (aNatural) ;returns natural
   ...
   (method subtract:withDifference:ifNegative: (aNatural diffBlock exnBlock)
      (self compare:withLt:withEq:withGt: aNatural
                                 [block () (exnBlock value)]
                                 [block () (diffBlock value: (NatZero new))]
                                 [block () (diffBlock value:
                                             (self minus:borrow: aNatural 0))]))

   (method sdiv: (n) (self sdivmod:with: n [block (q r) q])) ;returns natural
   (method smod: (n) (self sdivmod:with: n [block (q r) r])) ;returns int

   (method sdivmod:with: (aSmallInteger aBlock) (self subClassResponsibility))

   (method decimal () (self subclassResponsibility)) ;returns natural
   (method isZero  () (self subclassResponsibility)) ;returns bool
...
(class NatZero
   [subclass-of Natural]
   (class-method new () (super new)) ;returns natural

   ;data returns
   (method modBase () 0) ; private
   (method divBase () (NatZero new)) ; private
   (method timesBase () (NatZero new)) ; private
   ...
   (method decimal () ((List new) add: 0)) ;;TODO this doesn't work
   (method isZero  () true)
   ...
   (method minus:borrow: (aNatural c) (NatZero new)) ; private
...
(class NatNonZero
   ...
   (class-method new:: (y z) ((super new) setn:d: y z))
   (method setn:d: (a b) (set n a) (set d b) self)

   ;data returns
   (method modBase () d) ; private
   (method divBase () n) ; private
   (method timesBase () (Natural first:rest: 0 self)); private
   ;comparison
   (method compare:withLt:withEq:withGt: (aNatural ltBlock eqBlock gtBlock)
      ((aNatural isZero) ifTrue:ifFalse:
          gtBlock
          [block () (n compare:withLt:withEq:withGt:
                    (aNatural divBase)
                    ltBlock
                    [block () (((self modBase) = (aNatural modBase))
                        ifTrue:ifFalse:
                            eqBlock
                            [block () (((self modBase) > (aNatural modBase))
                                ifTrue:ifFalse:
   ...
   (method sdivmod:with: (aSmallInteger aBlock) (
       n sdivmod:with: aSmallInteger
            [block (q r) (aBlock value:value:
                ((q timesBase) + (Natural fromSmall:
                (((r * (Natural base)) + d) div: aSmallInteger)));end of first
                (((r * (Natural base)) + d) mod: aSmallInteger))];end of second
       )
    )
   ;arithmetic
   ...
   (method * (aNatural) (
       (aNatural isZero) ifTrue:ifFalse:
           [block () (NatZero new)]
           [block () (
               [block (m1 d1 m2 d2) (((Natural fromSmall: (d1 * d2)) + (
                    ((m1 * (Natural fromSmall: d2)) +
                    (m2 * (Natural fromSmall: d1))) timesBase)) +
                    (((m1 * m2) timesBase) timesBase))
                ] value:value:value:value: n d (aNatural divBase)
                                                             (aNatural modBase))
          ]
   ))
   ...
   (method isZero  () false)
   (method decimal () (
       ((self sdiv: 10) isZero) ifTrue:ifFalse:
           [block () ((List new) addLast: (self smod: 10))]
           [block () (((self sdiv: 10) decimal) addLast: (self smod: 10))]
       )
   )
   ...
   (method plus:carry: (aNatural c)
      (Natural first:rest:
          (((d + ((aNatural modBase) + c)) + (Natural base)) mod:
                                                                 (Natural base))
          ((aNatural isZero) ifTrue:ifFalse:
              [block () (n plus:carry: aNatural c)]
              [block () (
                 (((d + (aNatural modBase)) + c) > ((Natural base) - 1))
                    ifTrue:ifFalse:
                        [block () (n plus:carry: (aNatural divBase) 1)]
                        [block () (n plus:carry: (aNatural divBase) 0)]
                    )]
          )
      )
   ) ; private
   ...
   (method minus:borrow: (aNatural c) (
      Natural first:rest:
        (((d - ((aNatural modBase) + c)) + (Natural base)) mod: (Natural base))
        ((aNatural isZero) ifTrue:ifFalse:
            [block () ((c = 0) ifTrue:ifFalse:
                [block () n]
                [block () (n minus:borrow: (Natural fromSmall: c) 0)]
            )]
            [block () (n minus:borrow: (aNatural divBase)
                ((d < ((aNatural modBase) + c)) ifTrue:ifFalse:
                    [block () 1]
                    [block () 0]
                )
            )]
...
(class LargeInteger
  ...
  (class-method fromSmall: (anInteger)
     ((anInteger isNegative) ifTrue:ifFalse:
        {(((self fromSmall: 1) + (self fromSmall: ((anInteger + 1) negated)))
          negated)}
        {((LargePositiveInteger new) magnitude: (Natural fromSmall:
            anInteger))}))
  ...
  ;; double dispatch
  (method addLargePos: (aLargePos) (self subClassResponsibility))
  (method addLargeNeg: (aLargeNeg) (self subClassResponsibility))
  (method multLargePos: (aLargePos) (self subClassResponsibility))
  (method multLargeNeg: (aLargeNeg) (self subClassResponsibility))

  (method addSmallIntegerTo: (aSmallInteger) (self + (LargeInteger
                                                    fromSmall: aSmallInteger)))
  (method subSmallIntegerTo: (aSmallInteger) (self - (LargeInteger
                                                    fromSmall: aSmallInteger)))
  (method multiplySmallIntegerTo: (aSmallInteger) (self * (LargeInteger
                                                    fromSmall: aSmallInteger)))
  (method divSmallIntegerTo: (aSmallInteger) (self div: (LargeInteger
                                                    fromSmall: aSmallInteger)))
)
...
(class LargePositiveInteger
    [subclass-of LargeInteger]
      ...
      (method print () (magnitude print))
      (method isNegative () false)
      (method isNonnegative () true)
      (method isStrictlyPositive () ((magnitude isZero) not))

      (method +   (aNumber)     (aNumber addLargePos: self))
      (method *   (aNumber)     (aNumber multLargePos: self))
      (method negated    ()     (LargeNegativeInteger withMagnitude: magnitude))

      (method sdiv: (aSmallInteger) ((aSmallInteger isStrictlyPositive)
            ifTrue:ifFalse:
            {(LargePositiveInteger withMagnitude:
                                              (magnitude sdiv: aSmallInteger))}
            {((((self - (LargeInteger fromSmall: aSmallInteger)) -
                (LargeInteger fromSmall: 1)) sdiv: (aSmallInteger negated))
                negated)}
      ))

      (method smod: (aSmallInteger) ((aSmallInteger isStrictlyPositive)
            ifTrue:ifFalse:
            {(LargePositiveInteger withMagnitude:  (magnitude smod:
                aSmallInteger))}
            {((((self - (LargeInteger fromSmall: aSmallInteger)) -
                (LargeInteger fromSmall: 1)) smod: (aSmallInteger negated))
                negated)}))

      ;; double dispatch
      (method addLargePos: (aLargePos) (LargePositiveInteger withMagnitude:
                                        (magnitude + (aLargePos magnitude))))
      (method addLargeNeg: (aLargeNeg) (
          (magnitude > (aLargeNeg magnitude)) ifTrue:ifFalse:
              [block () (LargePositiveInteger withMagnitude: (magnitude -
                                                  (aLargeNeg magnitude)))]
              [block () (LargeNegativeInteger withMagnitude: ((aLargeNeg
                                                  magnitude) - magnitude))])
      )
      (method multLargePos: (aLargePos) (LargePositiveInteger withMagnitude:
                                          (magnitude * (aLargePos magnitude))))
      (method multLargeNeg: (aLargeNeg) (LargeNegativeInteger withMagnitude:
                                          (magnitude * (aLargePos magnitude))))
)
...
(class LargeNegativeInteger
    [subclass-of LargeInteger]
      ...
      (method print () (('- print) + (magnitude print))) ;;TODO check
      (method isNegative () true)
      (method isNonnegative () false)
      (method isStrictlyPositive () false)

      (method +   (aNumber)     (aNumber addLargeNeg: self))
      (method *   (aNumber)     (aNumber multLargeNeg: self))
      (method negated    ()     (LargePositiveInteger withMagnitude: magnitude))

      (method sdiv: (aSmallInteger) ((self negated) sdiv:
                                                (aSmallInteger negated)))

      (method smod: (aSmallInteger) ((self negated) smod:
                                                (aSmallInteger negated)))

      ;; double dispatch
      (method addLargePos: (aLargePos) (
          (magnitude < (aLargePos magnitude)) ifTrue:ifFalse:
              [block () (LargePositiveInteger withMagnitude:
                                           ((aLargePos magnitude) - magnitude))]
              [block () (LargeNegativeInteger withMagnitude:
                                           (magnitude - (aLargePos magnitude)))]
      ))
      (method addLargeNeg: (aLargeNeg) (LargeNegativeInteger
                            withMagnitude: (magnitude + (aLargeNeg magnitude))))

      (method multLargePos: (aLargePos) (LargeNegativeInteger withMagnitude:
                                          (magnitude * (aLargePos magnitude))))
      (method multLargeNeg: (aLargeNeg) (LargePositiveInteger withMagnitude:
                                          (magnitude * (aLargePos magnitude))))
)
...
(class Float
    ...
    (method + (x-prime)
        ((exp >= (x-prime exp)) ifTrue:ifFalse:
            {(Float mant:exp:
                         ((mant * (10 raisedToInteger: (exp - (x-prime exp)))) +
                                 (x-prime mant))
                              (x-prime exp))}
            {(x-prime + self)}))
    (method * (x-prime)
...
(class KeyedCollection
    ...
    (method do: (aBlock)
        (self associationsDo:
                             [block (anAssoc) (aBlock value: (anAssoc value))]))
    (method at: (key)
    ...
    (method associationAt:ifAbsent: (key exnBlock)
        (self associationsDo:
                             [block (x) (((x key) = key) ifTrue: {(return x)})])
        (exnBlock value))
...
(class Dictionary
    ...
    (method removeKey:ifAbsent: (key exnBlock)
       ...
       (set table (table reject:
                               [block (assn) (key = (assn key))])) ;remove assoc
       value-removed)
